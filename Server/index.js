...
app.get('/mymap', (req, res) => {
  res.render('map', { text: 'This is EJS'})
})
...
app.get('/intro', (req, res) => {
  res.render('agency', { text: 'This is EJS'})
})
...
var monumentRouter = require('./routes/monuments');

var campingRouter = require('./routes/campingCenters');
var bookingRouter = require('./routes/bookings');
var bookingProdRouter = require('./routes/bookingsProd');
var bookingGuestRouter = require('./routes/bookingsGuest');
var bookingResto = require('./routes/bookingsResto');

var circuitRouter = require('./routes/circuits');
...
app.use('/booking/prod', bookingProdRouter);
app.use('/booking/guest', bookingGuestRouter);
app.use('/booking/resto', bookingGuestRouter);
