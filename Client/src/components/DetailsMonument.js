...
const DetailsMonument = (props) => {

    const [detailsMonument, setDetailsMonument] = useState({
   ...
   const getEventHandler =  ()=>{
        ...
        api.get(`${process.env.REACT_APP_URL}monuments/details/${id}` , {
        headers: {
          "Access-Control-Allow-Origin": "*",
        },
      }).then((res) => {
        setDetailsMonument(res.data);
                ...
                <div className="row color-gray">
                    ...
                    <div className="col-lg-8 p-30px">
                        ...
                        <article>
                                ...
                                <img className="img-responsive" src={img} alt={detailsMonument.name}/>
                                   
                                </div>
                                <p>
                           {detailsMonument.name}
                        
                                </p>
                                <div className="bottom-article">
                                    <ul className="meta-post">
                                        <li>{detailsMonument.desc} </li>
                                    </ul>
                                </div>
                                <div className="bottom-article">
                                <ul className="meta-post">
                                        <li>{detailsMonument.details} </li>
                                    </ul>
                    ...
                    <div className="col-lg-4 p-30px">
                        ...
                        <div className="widget">
                            ...
                            <div className="recent">
                                {
                                    imgs.map((x,i)=>{
                                        return(
                                            <div>
                                            <img src={imgs[i]} alt={detailsMonument.name} className="pull-left" alt="#" />
                          ...
                          <Player>
      <source src={detailsMonument.videos[0]} />
    </Player>
    <ReactPlayer
                  url={detailsMonument.audios[0]}
                  width="260px"
                  height="50px"
                  playing={false}
                  controls={true}
...
export default DetailsMonument;