...
class MapsCult extends React.Component {
  constructor() {
    super();
    this.state = {
      lat: 36.397502,
  ...
  componentDidMount() {
    ...
    axios.get(`${process.env.REACT_APP_URL}placee/circuit/culturel` , {
      headers: {
...
console.log(this.state.places);
  ...
  render() {
    ...
    const way= [[36.3979902,10.1459361],
    [36.387511, 10.130815],
    [36.64,10.13],
  ]
    console.log(this.state.places);
...
export default withStyles(useStyles)(MapsCult);