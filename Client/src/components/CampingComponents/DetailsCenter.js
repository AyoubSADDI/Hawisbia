...
const DetailsCenter = (props) => {
   ...
   const getcampingHandler =  ()=>{
        ...
        api.get(`${process.env.REACT_APP_URL}camping/`+props.match.params.id , {
        headers: {
    ...
    <div className="row color-gray">
        ...
        <div className="col-lg-8 p-30px">
            ...
            <article>
                    ...
                    <img className="img-responsive" src={details.imgCollection[0]} alt={details.name}/>
                        <div className="post-heading">
                            <h3>{details.price} DT</h3>
                        </div>
                    </div>
                    <p>
               {details.description}
