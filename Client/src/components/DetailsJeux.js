...
const DetailsJeux = (props) => {

    const [detailsJeux, setDetailsJeux] = useState({
        nameJeux :""
    });
   ...
   const getEventHandler =  ()=>{
        ...
        api.get(`${process.env.REACT_APP_URL}jeux/`+props.match.params.id , {
        headers: {
          "Access-Control-Allow-Origin": "*",
        },
      }).then((res) => {
       setDetailsJeux(res.data);
       setLoading(false);
        //console.log("ayoub"+res.data.nameJeux);
            ...
            <div className="row color-gray">
                ...
                <div className="col-lg-8 p-30px">
                    ...
                    <article>
                            ...
                            <img className="img-responsive" src={detailsJeux.imgCollection[0]} alt={detailsJeux.nameJeux}/>
                                <div className="post-heading">
                                    <h3><a href="#">Fierent adipisci iracundia est ei</a></h3>
                                </div>
                            </div>
                            <p>
                       {detailsJeux.descriptionJeux}
