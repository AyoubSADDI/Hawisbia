...
const DetailsHouse = (props) => {
   ...
   const getEventHandler =  ()=>{
    ...
    api.get(`${process.env.REACT_APP_URL}accomodation/`+props.match.params.id , {
        headers: {
          "Access-Control-Allow-Origin": "*",
        },
      }).then((res) => {
        setDetailsHouse(res.data);
		...
		<div className="row color-gray">
			...
			<div className="col-lg-8 p-30px">
				...
				<article>
                        ...
                        <img className="img-responsive" src={detailsHouse.imgCollection[0]} alt={detailsHouse.name}/>
