...
const Details = (props) => {
   ...
   const getEventHandler =  ()=>{
        ...
        api.get(`${process.env.REACT_APP_URL}placee/`+props.match.params.id , {
        headers: {
       ...
       setLoading(false);
        console.log("ayoub"+res.data.lanPlace);
		...
		<div className="row color-gray">
			...
			<div className="col-lg-8 p-30px">
				...
				<article>
                        ...
                        <img className="img-responsive" src={process.env.PUBLIC_URL +`/uploads/places/${img}`} alt={details.namePlace}/>
							<div className="post-heading">
								<h3><a href="#">Fierent adipisci iracundia est ei</a></h3>
							</div>
						</div>
						<p>
                   {details.descriptionPlace}
                   {details.lanPlace}
						</p>
					...
					<div className="recent">
                        {
                            imgs.map((x,i)=>{
                                return(
                                    <div>
                                    <img src={process.env.PUBLIC_URL +`/uploads/places/${imgs[i]}`} alt={details.namePlace} className="pull-left" alt="#" />
